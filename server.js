...
let connectionString = 'mongodb+srv://todoAppUser:todoAppUser@cluster0-otzdy.mongodb.net/TodoApp?retryWrites=true&w=majority'
...
function passwordProtected(request, responce, next) {
    ...
    if (request.headers.authorization == "Basic YWRtaW46YWRtaW4=") {
        ...
        responce.status(401).send("Authentication required");
    }
}
...
app.post('/delete-item', function (request, responce) {
